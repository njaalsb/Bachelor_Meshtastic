...
# Oppdaterte stier som peker inn i undermappen:
...
#
ZOOM_MODUS   = "auto"      # Endret fra "manuell" til "auto"
MARGIN_METER = 1500        # Øk denne til f.eks. 1500 for å få litt "luft" rundt de ytterste punktene
